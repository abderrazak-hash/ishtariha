...
class IshSelector extends StatefulWidget {
  String title;
  ...
  @override
  State<IshSelector> createState() => _IshSelectorState();
}

class _IshSelectorState extends State<IshSelector> {
  Random rnd = Random();
  double border = 0.0;
  ...
  @override
  void didUpdateWidget(covariant IshSelector oldWidget) {
